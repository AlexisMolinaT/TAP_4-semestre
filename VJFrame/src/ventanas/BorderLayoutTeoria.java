 ...
 * @author alext
 */
public class BorderLayoutTeoria extends javax.swing.JFrame {

    /**
     * Creates new form LayoutTeoria
     */
    public BorderLayoutTeoria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorderLayoutTeoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorderLayoutTeoria().setVisible(true);
            }
        });
    }
