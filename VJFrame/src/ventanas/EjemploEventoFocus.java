...
public class EjemploEventoFocus extends JFrame{
    ...
    public EjemploEventoFocus(){
        ...
        txt_edad.setBackground(Color.black);
        ...
        lbl_nombre.setBounds(220, 100, 200, 50);

        lbl_nombre.setBounds(100, 160, 100, 50);
        lbl_nombre.setBounds(220, 160, 200, 50);

        lbl_nombre.setBounds(100, 220, 100, 50);
        lbl_nombre.setBounds(220, 220, 200, 50);
